...
[docs]def get_template(template_name, dirs=_dirs_undefined, using=None):
    """
...
[docs]def select_template(template_name_list, dirs=_dirs_undefined, using=None):
    """
...
[docs]def render_to_string(template_name, context=None,
